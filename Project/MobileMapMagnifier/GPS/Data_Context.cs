...
namespace GPS
{
    ...
    public class Row : INotifyPropertyChanged, INotifyPropertyChanging
    {
        ...
        // Define item name: private field, public property and database column.
        private string _Icon_Source_Light;

        [Column]
        public string Icon_Source_Light
        {
            get
            {
                return _Icon_Source_Light;
            }
            set
            {
                if (_Icon_Source_Light != value)
                {
                    NotifyPropertyChanging("Icon_Source_Light");
                    _Icon_Source_Light = value;
                    NotifyPropertyChanged("Icon_Source_Light");
                }
            }
        }
        // Define item name: private field, public property and database column.
        private string _Icon_Source_Dark;

        [Column]
        public string Icon_Source_Dark
        {
            get
            {
                return _Icon_Source_Dark;
            }
            set
            {
                if (_Icon_Source_Dark != value)
                {
                    NotifyPropertyChanging("Icon_Source_Dark");
                    _Icon_Source_Dark = value;
                    NotifyPropertyChanged("Icon_Source_Dark");
                }
            }
        }
        // Define item name: private field, public property and database column.
